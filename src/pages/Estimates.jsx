...
export const Estimates = () => {
  ...
  return (
    <div className="flex flex-col gap-6 relative">
          ...
          filteredEstimates.map(est => (
            <Card key={est.id} className="p-4">
              ...
              <div className="flex justify-end gap-2 border-t pt-3 border-gray-100 mt-2">
                  ...
                  <IconButton icon={Trash2} className="text-secondary hover:text-error p-1" onClick={() => handleDelete(est.id)} aria-label="Usuń kosztorys" />
              </div>
            </Card>
          ))
        ) : (
      ...
      <button className="fab hidden-desktop" onClick={() => setIsFormOpen(true)} aria-label="Nowy kosztorys">
        <Plus size={24} />
      </button>
