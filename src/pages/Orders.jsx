...
export const Orders = () => {
  ...
  return (
    <div className="flex flex-col gap-6 relative">
            ...
            <Card key={order.id} className="p-4">
              ...
              <div className="flex justify-between items-center border-t pt-3 border-gray-100">
                  ...
                  <div className="flex gap-1">
                      <IconButton icon={Edit} className="text-secondary hover:text-primary p-1" onClick={() => handleEdit(order)} aria-label="Edytuj zlecenie" />
                      <IconButton icon={Trash2} className="text-secondary hover:text-error p-1" onClick={() => handleDelete(order.id)} aria-label="Usuń zlecenie" />
                  </div>
              </div>
            </Card>
          ))
      ...
      <button className="fab hidden-desktop" onClick={() => setIsFormOpen(true)} aria-label="Dodaj zlecenie">
        <Plus size={24} />
      </button>
