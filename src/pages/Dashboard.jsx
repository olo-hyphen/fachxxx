...
export const Dashboard = () => {
  ...
  const revenueData = useMemo(() => [
    { name: 'Sty', amount: 4000 },
    { name: 'Lut', amount: 3000 },
    { name: 'Mar', amount: 2000 },
    { name: 'Kwi', amount: 2780 },
    { name: 'Maj', amount: 1890 },
    { name: 'Cze', amount: 2390 },
  ], []);
  ...
  const orderStatusData = useMemo(() => {
    if (orders.length === 0) {
        return [
            { name: 'Nowe', value: 4 },
            { name: 'W trakcie', value: 3 },
            { name: 'Zakończone', value: 10 },
            { name: 'Anulowane', value: 1 },
          ];
    }
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))' }}>
        ...
        <StatCard title="Przychód (Msc)" value="12 450 PLN" icon={DollarSign} color="#10B981" />
