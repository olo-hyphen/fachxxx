...
export const Clients = () => {
  ...
  return (
    <div className="flex flex-col gap-6 relative">
            ...
            <Card key={client.id} className="p-4">
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-1">
                  <IconButton icon={Edit} className="text-secondary hover:text-primary" onClick={() => handleEdit(client)} aria-label="Edytuj klienta" />
                  <IconButton icon={Trash2} className="text-secondary hover:text-error" onClick={() => handleDelete(client.id)} aria-label="Usuń klienta" />
                </div>
              </div>
      ...
      {/* FAB for mobile */}
      <button className="fab hidden-desktop" onClick={() => setIsFormOpen(true)} aria-label="Dodaj klienta">
        <Plus size={24} />
      </button>
